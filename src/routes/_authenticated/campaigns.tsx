  ...
  return (
    <div className="mx-auto max-w-5xl animate-in fade-in slide-in-from-bottom-4 duration-500 py-20">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <h1 className="font-display text-4xl font-bold tracking-tight text-foreground">Campaigns</h1>
        <p className="mt-4 max-w-md text-base text-muted-foreground">
          Orchestrate multi-channel marketing campaigns. This feature is currently rolling out to beta users.
        </p>
      </div>
    </div>
  );
